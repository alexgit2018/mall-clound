...
//              mapdata.clear();
//              mapdata.put("id",orderitem.getId());
//              mapdata.put("orderSn",orderitem.getOrderSn());
//              mapdata.put("orderStatus",orderitem.getOrderStatus());
//              mapdata.put("actualPrice",orderitem.getActualPrice());
//              mapdata.put("orderStatusText", OrderEnum.getMessageByCode(orderitem.getOrderStatus().intValue()));
//              mapdata.put("orderOp", OrderEnum.build(orderitem.getOrderStatus().intValue()));
//              mapdata.put("aftersaleStatus",orderitem.getAftersaleStatus());
...
//                  goodsmap.clear();
//                  goodsmap.put("id", ordergooditem.getId());
//                  goodsmap.put("goodsName", ordergooditem.getGoodsName());
//                  goodsmap.put("number", ordergooditem.getNumber());
//                  goodsmap.put("picUrl", ordergooditem.getPicUrl());
//                  goodsmap.put("specifications", ordergooditem.getSpecifications());
//                  goodsmap.put("price",ordergooditem.getPrice());
//                  goodsdata.add(goodsmap);
                    model.orderGoods.add(goodsModel);
                }

                orders.add(model);
                //mapdata.put("goodslist",goodsdata);
