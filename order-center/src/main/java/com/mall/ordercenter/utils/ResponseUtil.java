...
public class ResponseUtil {
    ...
    public static Object okList(List list, int total) {
        Map<String, Object> data = new HashMap<String, Object>();
        data.put("list", list);
    ...
    public static Object invalidpwd() {
        return fail(507, "密码错误");
    }

    public static Object invalidname() {
        return fail(508, "用户名错误");
    }

    public static Object invalidmobile() {
        return fail(509, "无效手机号码");
    }
}
